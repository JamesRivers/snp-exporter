...
![10-23-194529.png](attachments/2024-10-23-194529.png)
![10-23-194622.png](attachments/2024-10-23-194622.png)
![10-23-194701.png](attachments/2024-10-23-194701.png)
![10-23-194728.png](attachments/2024-10-23-194728.png)
...
- You can check the SNP endpoints as follows: `http://localhost:8080/metrics/10.10.10.10/9089` or whichever port you are using for the exporter.
...
- an example SNP dashboard JSON file is provided in the repo - `SNP-EXPORTER-DEFAULT.json` - import this file and you will see the SNP metrics in Grafana.

## Roadmap Items

- Add more metrics to the exporter - general
- Add SNP logs to the exporter, either via WS or the API
- Add option on the grafana dashboard to select and load an SNP preset
